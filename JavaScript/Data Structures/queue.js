 ...
 * @class
 * @typedef {object}
 * @property {number} length - The number of items in the queue.
 * @property {*[]} array - The array structure that stores the values in the queue.
 */
class Queue {
	/**
	...
	/**
	 * The array structure that stores values for the queue.
	 * @type {*[]}
	 * @private
	 */
	#array;
